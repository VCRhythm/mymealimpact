...
class FoodsControllerTest < ActionController::TestCase
  ...
  test "should create food" do
    assert_difference('Food.count') do
      post :create, food: { detail_source: @food.detail_source, name: @food.name, source: @food.source }
    end
  ...
  test "should update food" do
    patch :update, id: @food, food: { detail_source: @food.detail_source, name: @food.name, source: @food.source }
    assert_redirected_to food_path(assigns(:food))
  end
